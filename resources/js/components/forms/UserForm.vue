    ...
    <div class="content sm">
        ...
        <div class="row">
            ...
            <!-- <div v-if="activeItem == 1" class="col-12 tab-pane fade" :class="{ 'active show': isActive(1) }" id="1">
                <div class="caja sm mb-15 especial">
                    <h2 class="inline-b mr-15">Proporciona los datos de la persona de contacto</h2> 
                    <div class="form-group">
                        <label for="name">Nombre*:</label>
                        <input type="text" name="name" class="form-control" id="name" placeholder="Nombre" v-model="personData.name">
                    </div>
                    <div class="form-group">
                        <label for="lastName">Apellido*:</label>
                        <input type="text" name="lastName" class="form-control" id="lastName" placeholder="Apellido" v-model="personData.lastName">
                    </div>
                    <div class="form-group">
                        <label for="identity">Identificación Fiscal*:</label>
                        <input type="text" name="identity" class="form-control" id="identity" placeholder="Identificación fiscal" v-model="personData.identity">
                    </div>
                    <div class="form-group">
            ...
            <div v-if="activeItem == 1" class="col-12 tab-pane fade" :class="{ 'active show': isActive(1) }" id="1">
                <div class="caja mb-30">
                    <h3 class="inline-b mr-15">Datos de la empresa</h3>
                ...
                <!-- <div class="caja mb-30">
                    <h3 class="inline-b mr-15">Persona de contacto</h3>
                    <p><span class="bold">Nombre y Apellido: </span><br> {{ personData.name + ' ' +personData.lastName}} </p>
                    <p><span class="bold">Identificación Fiscal: </span><br> {{ personData.identity }} </p>
